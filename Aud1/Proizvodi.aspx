<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proizvodi.aspx.cs" Inherits="Aud1.Proizvodi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-xs-offset-1 col-8">
            <asp:ListBox ID="naslovi" runat="server" Height="250px" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="naslovi_SelectedIndexChanged" ></asp:ListBox>
        </div>
        <div class="col-4">
